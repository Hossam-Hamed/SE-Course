        ...
        module.exports = {
            ...
            seed: function(callback) {
                ...
                db.collection('Flights').count(function(err, count) {
                    ...
                    // seeding aeroplanes
                    var aeroplanes = JSON.parse(fs.readFileSync('aircraft.json', 'utf8')); db.collection('AeroPlanes').count(function(err, count) {
                    ...
                    //seeding airports
                    var airports = JSON.parse(fs.readFileSync('airports.json', 'utf8')); db.collection('Airports').count(function(err, count) {
                        // assert.equal(err, null);
                        if (count == 0) {
